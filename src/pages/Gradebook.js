...
function Gradebook({ Toggle, pageSet}) {
    return (
        <div className='px-3'>
            <Nav Toggle={Toggle} /> 
            <div className=''>
            ...
            <div className='container-fluid'>
                <div className='row g-3 my-2'>
                    <div className='col-md-12 p-1'>
                        <div className='card'>
                            <div className='card-body' style={{backgroundColor: '#E1F5EA', height: '6rem', position: 'relative'}} onClick={() => pageSet('course1')} >
                    ...
                    <div className='col-md-12 p-1'>
                        <div className='card'>
                            <div className='card-body' style={{backgroundColor: '#C5CFC8', height: '6rem', position: 'relative'}} onClick={() => pageSet('course2')}>
                    ...
                    <div className='col-md-12 p-1'>
                        <div className='card'>
                            <div className='card-body' style={{backgroundColor: '#F9D5BA', height: '6rem', position: 'relative'}} onClick={() => pageSet('course3')}>
